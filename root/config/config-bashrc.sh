...
# Changes 
#		'($debian_chroot)}\u@\h:\' to '($debian_chroot)}\u@`curl -s http://ipv4.icanhazip.com:\'
#		'($debian_chroot)}\[\033[01;32m\]\u@\h' to '($debian_chroot)}\[\033[01;32m\]\u@`curl -s http://ipv4.icanhazip.com`'

sudo cp /root/.bashrc /root/.bashrc.bak
sudo sed -i 's/($debian_chroot)}\\u\@\\h:\\/($debian_chroot)}\\u\@\`curl -s http:\/\/ipv4.icanhazip.com\`:\\/g' /root/.bashrc
sudo sed -i 's/($debian_chroot)}\\\[\\033\[01;32m\\\]\\u\@\\h/($debian_chroot)}\\\[\\033\[01;32m\\\]\\u\@\`curl -s http:\/\/ipv4.icanhazip.com\`/g' /root/.bashrc
...
sudo sed -i 's/($debian_chroot)}\\u\@\\h:\\/($debian_chroot)}\\u\@\`curl -s http:\/\/ipv4.icanhazip.com\`:\\/g' /home/steve/.bashrc
sudo sed -i 's/($debian_chroot)}\\\[\\033\[01;32m\\\]\\u\@\\h/($debian_chroot)}\\\[\\033\[01;32m\\\]\\u\@\`curl -s http:\/\/ipv4.icanhazip.com\`/g' /home/steve/.bashrc
